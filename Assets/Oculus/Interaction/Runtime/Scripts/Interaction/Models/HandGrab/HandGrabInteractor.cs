...
namespace Oculus.Interaction.HandGrab
{
        ...
        IHandGrabInteractor, IRigidbodyRef
    {
        ...
        protected override void InteractableUnselected(HandGrabInteractable interactable)
        {
            ...
            // Increase the linear velocity (adjust the multiplier as needed)
            throwVelocity.LinearVelocity *= 1.35f; // Increase linear velocity

            // Increase the angular velocity (adjust the multiplier as needed)
            throwVelocity.AngularVelocity *= 1.65f; // Increase angular velocity
